...
<body>
	...
	<div align="center"><img src="../includes/images/banners/Sale.jpg" /></div>

<br /><br />
	
    <div align="center"><h2>Sales Selection</h2></div>
...
<table width="90%" border="0" cellpadding="10px" align="center" style="text-align:center">
	<tr>
        ...
        <option value="sale">Price - High to Low</option>
        </select>
        </td><td>
	...
	?>
        <td><a href="index.php?pid=<?= $row['pid'] ?>&back=sales">
