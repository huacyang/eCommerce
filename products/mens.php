<?php 
	...
	$search = "SELECT p.pid AS pid, p.src AS src, p.name AS name, p.price AS price, s.sale AS sale
			   ...
			   WHERE p.gender='male' AND p.section LIKE '".$filter."'
...
<body>
	...
	<div align="center"><img src="../includes/images/banners/Mens.jpg" /></div>
    
<br /><br />
	
    <div align="center"><h2>Mens Selection</h2></div>
...
<table width="90%" border="0" cellpadding="10px" align="center" style="text-align:center">
	...
	?>
        <td><a href="index.php?pid=<?= $row['pid'] ?>&back=mens">
