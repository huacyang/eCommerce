<?php 
	...
	if (!isset($brand) || $brand == NULL) { $brand = "%"; }
	...
	$search = "SELECT p.pid AS pid, p.src AS src, p.name AS name, p.price AS price, s.sale AS sale
			   ...
			   WHERE p.brand NOT LIKE '0' AND p.brand LIKE '".$brand."' AND p.section LIKE '".$filter."'
...
<body>
	...
	<div align="center"><img src="../includes/images/banners/Brands.jpg" /></div>
    
<br /><br />
	
    <div align="center"><h2>Brands Selection</h2></div>

<div id="products">
<table width="1025px" border="0" cellpadding="10px" align="center" style="text-align:center">
	<tr>
	...
	?>
        <td><a href="index.php?pid=<?= $row['pid'] ?>&back=brands">
