...
<body>
	...
	<div align="center"><img src="../includes/images/banners/Misc.jpg" /></div>
    
<br /><br />
	
    <div align="center"><h2>Miscellaneous Selection</h2></div>
...
<table width="90%" border="0" cellpadding="10px" align="center" style="text-align:center">
	...
	?>
        <td><a href="index.php?pid=<?= $row['pid'] ?>&back=misc">
